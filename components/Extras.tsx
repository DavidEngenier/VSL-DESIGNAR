            ...
            >
              ...
              >
                ...
                <p className="text-2xl  text-center">
                  DiseÃ±os exclusivos en todo MÃ©xico
                </p>
              </div>
              ...
              >
                ...
                <h4 className="h4 mb-2"></h4>
                <p className="text-2xl  text-center">
                  Productos innovadores y con tecnologÃ­a Ãºnica
                </p>
              </div>
              ...
              >
                ...
                <h4 className="h4 mb-2"></h4>
                <p className="text-2xl  text-center">Souvenirs con NFC</p>
              </div>
              ...
              >
                ...
                <h4 className="h4 mb-2"></h4>
                <p className="text-2xl  text-center">
                  PersonalizaciÃ³n de productos por paradero turÃ­stico
                </p>
              </div>
              ...
              >
                ...
                <h4 className="h4 mb-2"></h4>
                <p className="text-2xl  text-center">
                  Productos con nuevas tecnologÃ­as 4.0
                </p>
              </div>
              ...
              >
                ...
                <h4 className="h4 mb-2"></h4>
                <p className="text-2xl  text-center">GarantÃ­as de compra</p>
              </div>
