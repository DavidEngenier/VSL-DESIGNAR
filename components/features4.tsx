        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 mb-12">
          <div className="py-12 md:py-20">
            ...
            <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20 ">
              <h2 className="text-2xl sm:text-2xl md:text-6xl lg:text-7xl font-semibold text-center text-gray-200 mx-auto text-center relative uppercase  sm:pt-8 lg:pt-12">
            ...
            >
             ...
             >
              ...
              <div>
                ...
                <p className="text-xl">
                Si no estas dispuesto a invertir
                </p>
              </div>
            </div>
