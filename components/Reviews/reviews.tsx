import Mediumstart from "./mediumstars";
import Startsamls from "./smallstars";
  ...
  <div className="row g-3">
    <div className="col-12 col-lg-4" data-aos="fade-left">
      <div className="bg-light p-4 d-flex h-100 justify-content-start align-items-center flex-column text-center">
        ...
        <p className="mb-3">
          I have shopped with them for a few years now. Very easy to select
          items, items always as described. Never had to return any item. Good
          value.
        </p>
    ...
    <div className="col-12 col-lg-4" data-aos="fade-left" data-aos-delay={300}>
      <div className="bg-light p-4 d-flex h-100 justify-content-start align-items-center flex-column text-center">
        ...
        <p className="mb-3">
          ...
          immediately and i got another delivery quite promptly. Also the
          product was absolutely lovely
        </p>
        <small className="text-muted d-block mb-2 fw-bolder">
          John Patrick, London
        </small>
